...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__peer_as','__local_as','__peer_type','__auth_password','__remove_private_as','__route_flap_damping','__send_community','__description','__peer_group_name','__total_paths','__total_prefixes',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__peer_group_name = YANGDynClass(base=unicode, is_leaf=True, yang_name="peer-group-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp', defining_module='openconfig-bgp', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'state']

  def _get_peer_as(self):
    """
    Getter method for peer_as, mapped from YANG variable /bgp/peer_groups/peer_group/state/peer_as (inet:as-number)
  ...
  def _set_peer_as(self, v, load=False):
    """
    Setter method for peer_as, mapped from YANG variable /bgp/peer_groups/peer_group/state/peer_as (inet:as-number)
  ...
  def _get_local_as(self):
    """
    Getter method for local_as, mapped from YANG variable /bgp/peer_groups/peer_group/state/local_as (inet:as-number)
...
autonomous system number.
  ...
  def _set_local_as(self, v, load=False):
    """
    Setter method for local_as, mapped from YANG variable /bgp/peer_groups/peer_group/state/local_as (inet:as-number)
    If this variable is read-only (config: false) in the
...
(iBGP) or external (eBGP).
  ...
  def _get_auth_password(self):
    """
    Getter method for auth_password, mapped from YANG variable /bgp/peer_groups/peer_group/state/auth_password (string)
...
neighboring devices.
  ...
  def _set_auth_password(self, v, load=False):
    """
    Setter method for auth_password, mapped from YANG variable /bgp/peer_groups/peer_group/state/auth_password (string)
    If this variable is read-only (config: false) in the
...
with a peer or group
  ...
  def _set_peer_group_name(self, v, load=False):
    ...
    """
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="peer-group-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp', defining_module='openconfig-bgp', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """peer_group_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="peer-group-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp', defining_module='openconfig-bgp', yang_type='string', is_config=False)""",
        })
