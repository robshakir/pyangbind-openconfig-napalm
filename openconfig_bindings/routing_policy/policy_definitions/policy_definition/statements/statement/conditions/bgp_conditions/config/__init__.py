...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'policy-definitions', u'policy-definition', u'statements', u'statement', u'conditions', u'bgp-conditions', u'config']
...
specified value
  ...
  def _get_next_hop_in(self):
    """
    Getter method for next_hop_in, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/config/next_hop_in (inet:ip-address)
...
update
  ...
  def _set_next_hop_in(self, v, load=False):
    """
    Setter method for next_hop_in, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/config/next_hop_in (inet:ip-address)
    If this variable is read-only (config: false) in the
...
the specified value
  ...
  med_eq = property(_get_med_eq, _set_med_eq)
  origin_eq = property(_get_origin_eq, _set_origin_eq)
  next_hop_in = property(_get_next_hop_in, _set_next_hop_in)
  afi_safi_in = property(_get_afi_safi_in, _set_afi_safi_in)
  local_pref_eq = property(_get_local_pref_eq, _set_local_pref_eq)
  route_type = property(_get_route_type, _set_route_type)
