...
import config
import state
import match_interface
import match_prefix_set
import match_neighbor_set
import match_tag_set
import bgp_conditions
class conditions(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__match_interface','__match_prefix_set','__match_neighbor_set','__match_tag_set','__bgp_conditions',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__match_interface = YANGDynClass(base=match_interface.match_interface, is_container='container', yang_name="match-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
    self.__match_prefix_set = YANGDynClass(base=match_prefix_set.match_prefix_set, is_container='container', yang_name="match-prefix-set", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
    ...
    self.__match_neighbor_set = YANGDynClass(base=match_neighbor_set.match_neighbor_set, is_container='container', yang_name="match-neighbor-set", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
...
in the match-options-set leaf
  ...
  match_interface = property(_get_match_interface, _set_match_interface)
  match_prefix_set = property(_get_match_prefix_set, _set_match_prefix_set)
  match_neighbor_set = property(_get_match_neighbor_set, _set_match_neighbor_set)
  match_tag_set = property(_get_match_tag_set, _set_match_tag_set)
  bgp_conditions = property(_get_bgp_conditions, _set_bgp_conditions)


  _pyangbind_elements = {'config': config, 'state': state, 'match_interface': match_interface, 'match_prefix_set': match_prefix_set, 'match_neighbor_set': match_neighbor_set, 'match_tag_set': match_tag_set, 'bgp_conditions': bgp_conditions, }
