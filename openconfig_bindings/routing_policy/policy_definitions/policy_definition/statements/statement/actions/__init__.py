...
class actions(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__igp_actions','__bgp_actions',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igp_actions = YANGDynClass(base=igp_actions.igp_actions, is_container='container', yang_name="igp-actions", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
  ...
  def _get_igp_actions(self):
    """
    Getter method for igp_actions, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/igp_actions (container)

    YANG Description: Actions to set IGP route attributes; these actions
apply to multiple IGPs
    """
    return self.__igp_actions
      
  def _set_igp_actions(self, v, load=False):
    """
    Setter method for igp_actions, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/igp_actions (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igp_actions is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igp_actions() directly.

    YANG Description: Actions to set IGP route attributes; these actions
apply to multiple IGPs
    """
    try:
      t = YANGDynClass(v,base=igp_actions.igp_actions, is_container='container', yang_name="igp-actions", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """igp_actions must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=igp_actions.igp_actions, is_container='container', yang_name="igp-actions", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)""",
        })

    self.__igp_actions = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igp_actions(self):
    self.__igp_actions = YANGDynClass(base=igp_actions.igp_actions, is_container='container', yang_name="igp-actions", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='container', is_config=True)
  ...
  def _set_bgp_actions(self, v, load=False):
    ...
    """
    try:
      t = YANGDynClass(v,base=bgp_actions.bgp_actions, is_container='container', yang_name="bgp-actions", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  igp_actions = property(_get_igp_actions, _set_igp_actions)
  bgp_actions = property(_get_bgp_actions, _set_bgp_actions)


  _pyangbind_elements = {'config': config, 'state': state, 'igp_actions': igp_actions, 'bgp_actions': bgp_actions, }
