...
class state(PybindBase):
  ...
  from YANG module openconfig-routing-policy - based on the path /routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/set-ext-community/inline/state. Each member element of
...
set-ext-community action
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'policy-definitions', u'policy-definition', u'statements', u'statement', u'actions', u'bgp-actions', u'set-ext-community', u'inline', u'state']

  def _get_communities(self):
    """
    Getter method for communities, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_ext_community/inline/state/communities (union)
...
with a list.
  ...
  def _set_communities(self, v, load=False):
    """
    Setter method for communities, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_ext_community/inline/state/communities (union)
...
with a list.
  ...
  communities = property(_get_communities)
