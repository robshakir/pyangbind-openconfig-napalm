...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'policy-definitions', u'policy-definition', u'statements', u'statement', u'actions', u'bgp-actions', u'set-as-path-prepend', u'config']
...
supported by the implementation.
  ...
  repeat_n = property(_get_repeat_n, _set_repeat_n)
