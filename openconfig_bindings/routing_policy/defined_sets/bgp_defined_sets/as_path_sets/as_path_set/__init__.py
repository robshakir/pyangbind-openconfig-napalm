...
class as_path_set(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__as_path_set_name','__config','__state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__as_path_set_name = YANGDynClass(base=ReferenceType(referenced_path='../config/as-path-set-name', caller=self._path() + ['as-path-set-name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="as-path-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'defined-sets', u'bgp-defined-sets', u'as-path-sets', u'as-path-set']
  ...
  _pyangbind_elements = {'as_path_set_name': as_path_set_name, 'config': config, 'state': state, }
