...
class ext_community_set(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ext_community_set_name','__config','__state',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'defined-sets', u'bgp-defined-sets', u'ext-community-sets', u'ext-community-set']
  ...
  _pyangbind_elements = {'ext_community_set_name': ext_community_set_name, 'config': config, 'state': state, }
