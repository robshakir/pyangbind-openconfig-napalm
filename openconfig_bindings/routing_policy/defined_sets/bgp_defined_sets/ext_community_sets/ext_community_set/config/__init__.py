...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'defined-sets', u'bgp-defined-sets', u'ext-community-sets', u'ext-community-set', u'config']
...
used to reference the set in match conditions
    """
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="ext-community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ext_community_set_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="ext-community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='string', is_config=True)""",
        })
  ...
  ext_community_set_name = property(_get_ext_community_set_name, _set_ext_community_set_name)
  ext_community_member = property(_get_ext_community_member, _set_ext_community_member)
