...
class community_set(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__community_set_name','__config','__state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__community_set_name = YANGDynClass(base=ReferenceType(referenced_path='../config/community-set-name', caller=self._path() + ['community-set-name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-policy', u'defined-sets', u'bgp-defined-sets', u'community-sets', u'community-set']
  ...
  _pyangbind_elements = {'community_set_name': community_set_name, 'config': config, 'state': state, }
